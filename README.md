...
- Hook scope defaults to a conservative core (`Reg*ExW` + close/delete) for maximum process compatibility. To enable the full legacy/ANSI hook set, set `HKLM_WRAPPER_HOOK_MODE=all` before launch.
